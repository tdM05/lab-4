...
public class Config {
    ...
    // DONE Task 4: add code for the new GetTopGradeUseCase
    //  following the same pattern as the other use cases above.
    public final GetTopGradeUseCase getTopGradeUseCase() {
